...
jQuery(document).ready(function() {
  ...
  var $bannerNav = jQuery('.banner_nav .banner_spacer');
    
  $bannerNav
     .before('<img src="/images/banner_scroll_left.png" id="banner_scroll_l" class="banner_scroll l" />')
     .after('<img src="/images/banner_scroll_right.png" id="banner_scroll_r" class="banner_scroll r" />');
